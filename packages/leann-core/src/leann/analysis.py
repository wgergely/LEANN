...
class CodeAnalyzer:
    ...
    def get_semantic_chunks(self, code: str, file_path: str = "", metadata: Dict[str, Any] = None) -> List[Dict[str, Any]]:
        """
    ...
    def _extract_imports(self, tree, code: str) -> List[str]:
        ...
        if self.language == "python":
            query = Query(self._language_obj, """
